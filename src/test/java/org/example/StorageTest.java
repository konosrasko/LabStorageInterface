...
class StorageTest {
    ...
    void testingAssignExit(){
        ...
        storage.addStoreKeeper(2,"duo");
        storage.addStoreKeeper(3,"tria");
        storage.addStoreKeeper(4,"tessera");
        storage.addStoreKeeper(5,"pente");
        ...
        slip.addProduct(3,1,ProductCategory.FIFO,"ena");
        slip.addProduct(4,2,ProductCategory.FIFO,"ena");
        slip.addProduct(5,2,ProductCategory.FIFO,"ena");

        storage.entrySlip(slip,1);
        storage.assign(1);

        storage.exit(1,1,3);
        System.out.println(storage.getSpotsList());
